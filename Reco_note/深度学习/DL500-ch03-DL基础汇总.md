---
title: DL500_ch03_DL基础汇总
date: 2019-10-14 23:23:12
tags:
- 深度学习
categories:
- 深度学习500问汇总
...
---
### 前言
- 本文原文地址为[GitHub](https://github.com/yearing1017/DeepLearning-500-questions/blob/master/ch03_%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%E5%9F%BA%E7%A1%80/%E7%AC%AC%E4%B8%89%E7%AB%A0_%E6%B7%B1%E5%BA%A6%E5%AD%A6%E4%B9%A0%E5%9F%BA%E7%A1%80.md),该项目为深度学习500问。
- 由于在GitHub上不支持数学公式，所以将其整理发为博文，原文未更改。
- 正在准备反复看该项目的文章，每看一遍都有新的认识。
<!--more-->
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-1.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-2.jpg)

当输入为 $0$，$1$ 时，感知机输出为 $ 0 \times (-2) + 1 \times (-2) + 3 = 1$。

复杂一些的感知机由简单的感知机单元组合而成：

![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-3.jpg)

**多层感知机**

多层感知机由感知机推广而来，最主要的特点是有多个神经元层，因此也叫深度神经网络。相比于单独的感知机，多层感知机的第 $ i $ 层的每个神经元和第 $ i-1 $ 层的每个神经元都有连接。

![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-4.jpg)

输出层可以不止有$ 1$ 个神经元。隐藏层可以只有$ 1$ 层，也可以有多层。输出层为多个神经元的神经网络例如下图所示：

![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-5.jpg)

### 3.1.2 神经网络有哪些常用模型结构？

下图包含了大部分常用的模型：

![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-6.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-7.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-8.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-9.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-10.jpg)
...
$$
a_4 = \sigma(w^T \cdot a) = \sigma(w_{41}x_1 + w_{42}x_2 + w_{43}x_3 + w_{4b})
$$
其中 $ w_{4b} $ 是节点 4 的偏置项。
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-11.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-12.jpg)

以此类推，计算出全部的Feature Map。

![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-13.jpg)

当步幅为 2 时，Feature Map计算如下

![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-14.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-15.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-16.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-17.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-18.jpg)

输入层包含神经元 $ i_1, i_2 $，偏置 $ b_1 $；隐含层包含神经元 $ h_1, h_2 $，偏置 $ b_2 $，输出层为  $ o_1, o_2 $，$ w_i $ 为层与层之间连接的权重，激活函数为 $sigmoid$ 函数。对以上参数取初始值，如下图所示：

![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-19.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-20.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-21.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-22.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-23.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-24.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-25.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-26.jpg)

继续看下面的图，三个输入通过 softmax 后得到一个数组 $ [0.05 , 0.10 , 0.85] $，这就是 soft 的功能。

![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-27.jpg)

更形象的映射过程如下图所示：

![****](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-28.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-29.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-30.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-31.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-32.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-33.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-34.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-35.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-36.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-37.jpg)
...
![](https://blog-1258986886.cos.ap-beijing.myqcloud.com/500%E9%97%AE/2-38.jpg)
